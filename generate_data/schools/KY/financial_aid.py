"""
Financial Aid data generation for Thomas More University (KY)
"""
import sys
import os
...
def generate_financial_aid_data(num_records: int = 100) -> List[Dict]:
    """Generate synthetic financial aid data for KY."""
...
def main():
    """Main function to generate financial aid data for KY."""
    print(f"\n{'='*60}")
